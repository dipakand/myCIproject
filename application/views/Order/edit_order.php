            ...
            <form method="post" >
                <div class="col-md-3 col-md-offset-2"><?php //echo set_value('sale_exe'); ?>
                    <select name="sale_exe" class="form-control" >
                        ...
                        <?php
                        foreach($sales_executive_rows as $sale_exe1)
                        {

                        ?>
                        <option value="<?php echo $sale_exe1->id;?>" <?php echo $sale_exe == $sale_exe1->id ? 'selected' : '' ; ?> ><?php echo ucwords($sale_exe1->name);?></option>
                        <?php
                        }
                        ?>
                    </select>     
                ...
                <div class="col-md-3"><?php //echo set_value('sel_brand[]'); ?>
                    ...
                    <select name="sel_brand[]" multiple id="sel_brand" class="form-control" >
                        ...
                        {
                        ?>
                        <option value="<?php echo $brand->id; ?>" <?php if(in_array($brand->id,$sel_brand)) { echo "SELECTED"; } ?> ><?php echo $brand->name; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            foreach($sel_brand as $kee=>$value)
            {
                ...
                foreach($fetch111 as $product)
                {
                    ...
                    foreach($fetch as $desc)
                    {
                        ...
                        if(in_array($pro_id,$ids)){
                            //$values = array_search($pro_id,$edit_arra);
                            $values = $edit_arra[$pro_id];
                        }
                        else
                        {
                            $values = 0;
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" name="stock[<?php echo $desc->id;?>]" id="" class="form-control" value="<?php echo $values;?>" min="0">
                            </td>
                        </tr>
                        <?php
                    }
                ...
                <div class="col-sm-4 col-sm-offset-4">
                   <input type="hidden" name="edit" value="<?php echo $order_id?>" id="">
