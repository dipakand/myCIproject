    ...
    <div class="col-lg-12">
        ...
        <page size="A4" >
            <div class="col-sm-10 col-sm-offset-1">&nbsp;
                <a href="<?php echo site_url('ManageOrder');?>" class="btn btn-success pull-left"><span class="glyphicon glyphicon-chevron-left"></span> Back</a>&nbsp;    
                <a onclick="window.open('<?php echo site_url('PrintPage/'.$purchase_order_row->id);?>')" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-print"></span> Print</a>    
            </div> 
            <div class="col-sm-12">
                <div class="invoice-box" style="height:;">
                    <form method="post" enctype="multipart/form-data">
                        <div style="border:1px solid #000;">
                            <table align="center" style="width:100%;" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td style="">
                                        <?php 
                                        $this->db->where('vendor_details.id',$purchase_order_row->vendor_id);
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            <tr >
                                                <td style="text-align:left; font-size:12px; border:1px solid #000; border-left:none;"><b>&nbsp;BILL NO.</b> <?php echo $purchase_order_row->receipt?></td>
                                                <td style="text-align:center; font-size:12px; border:1px solid #000; border-right:none;"><b>BILL DATE :</b> <?php echo date('d-m-Y',strtotime($purchase_order_row->date));?></td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <table width="100.1%" style="text-align:center; " cellspacing="0" cellpadding="0">
                                        ...
                                        $s=0;
                                        $total=0;
                                        $etem1=unserialize($purchase_order_row->received);
                                        $count= count($etem1);
                                        $re_co=0;
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:11px; border:1px solid #ccc; text-align:left; padding-left:1%; text-transform:capitalize;">
                                                <?php 
                                            //$this->db->where('product_desc.id',$purchase_order_row->vendor_id);
                                        ...
                                        <tr>
                                            <table width=100% cellspacing="0" cellpadding="0" >
                                                ...
                                                <tr>
                                                    <td style="font-size:11px; border-left:1px solid #000; border-right:1px solid #000;"><b>&nbsp;  <?php //echo $purchase_order_row->?></b></td>
                                                    <td style="font-size:11px; text-align:right;"> <?php //echo round($purchase_order_row->,2);?> </td>
                                                </tr>
                                                <tr>
                        ...
                        <?php 
                        /* if($purchase_order_row->cod_percent > 0 )
                        {?>
                        <div style="text-align:left; margin-left:1%; font-size:11px;"><b>If payment done of cash. Please Pay <i class="fa fa-inr"></i> <?php //echo round($purchase_order_row->cod_amt,2); ?> /-.</b></div>
                        <?php
                        }    */     
                        ?>
