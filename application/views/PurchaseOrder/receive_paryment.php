<?php
$total_amt=$purchase_order_row->total_amt;
?>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <td><b>Pending Amount</b>
                        <input type="text" name="pending" value="<?php echo $total_amt;?>" class="form-control" readonly >
                    </td>
                    <td><b>Receive Amount</b>
                        <input type="number" min="0" value="<?php echo $total_amt;?>" id="receive_amt" class="form-control" name="receive_amt" placeholder="Enter Amount" required  >
                    </td>
                </tr>
            </table>
