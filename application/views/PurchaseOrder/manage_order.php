                ...
                <table class="table table-striped text-center table-responsive" id="example" width="100%">
                    <thead> 
                        ...
                        <tr>
                            ...
                            <td><b>Print</b></td>
                            <td><b>Received</b></td>
                            <td><b>Make <br>Payment</b></td>
                            <td><b>Order<br/>Cancel</b></td>
                            <td><b>Itemwise<br/>Cancel</b></td>
                            <td><b>Edit</b></td>
                        </tr>
                    </thead>
                    <?php 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                            <td colspan="6">
                                <div class="col-md-12 label label-default" style="font-size:20px; width=100%;">Cancelled </div>
                            </td>    
                            ...
                            <td>
                                ...
                                {
                                ?>
                                <a class="btn btn-primary disabled glyphicon glyphicon-list-alt"></a>
                                <?php
                                }
                                else
                                {
                                ?>
                                <a href="<?php echo site_url('ViewPurchaseOrder/'.$purchase->id); ?>" class="btn btn-primary glyphicon glyphicon-list-alt"></a>
                                <?php
                                }
                                ?>
                            </td>
                            <td>
                                <?php 
                                if($purchase->recev_status == 0)
                                {
                                ?>
                                <a href="<?php echo site_url('ReceiveOrder/'.$purchase->id); ?>" class="btn btn-success glyphicon glyphicon-floppy-save"></a>
                                <?php
                                }
                                else
                                {
                                ?>
                                <a  class="btn btn-danger glyphicon glyphicon-floppy-save disabled"></a>
                                <?php
                                }
                                ?>
                            </td>
                            <td>
                                ...
                                {
                                ?>
                                <button class="btn btn-info glyphicon glyphicon-usd disabled"></button>
                                <?php
                                }
                                else
                                {
                                    if($purchase->receive_amt!='')
                                    { ?>
                                <button class="btn btn-info glyphicon glyphicon-usd disabled"></button>
                                <?php
                                    }else{
                                ?>
                                <a href="<?php echo site_url('PaymentReceiveOrder/'.$purchase->id); ?>" class="btn btn-info glyphicon glyphicon-usd"></a>
                            ...
                            <td>
                                ...
                                {
                                ?>
                                <button class="btn btn-default glyphicon glyphicon-trash disabled"></button>
                                <?php
                                }
                                else
                                {
                                ...
                                <?php 
                                    ...
                                    {
                                ?>
                                <a href="<?php echo site_url('CancelOrder/'.$purchase->id);?>" class="btn btn-default glyphicon glyphicon-trash"></a>
                                <?php
                                    }
                                    else
                                    {
                            ...
                            <td>
                                ...
                                {
                                ?>
                                <button class="btn btn-info disabled glyphicon glyphicon-remove"></button>
                                <?php
                                ...
                                <?php 
                                    ...
                                    {
                                ?>
                                <a href="<?php echo site_url('ItemWiseCancel/'.$purchase->id);?>" class="btn btn-info glyphicon glyphicon-remove"></a>
                                <?php
                                    }
                                    else
                                    {
                                ?>
                                <button class="btn btn-info glyphicon glyphicon-remove disabled"></button>
                                <?php
                                    }
                                ?>
                                <?php
                            ...
                            <td>
                                ...
                                {
                                ?>
                                <a href="<?php echo site_url('EditOrder/'.$purchase->id);?>" class="btn btn-primary glyphicon glyphicon-edit"></a>
                                <?php
                                }
                                else
                                {
                                ?>
                                <button class="btn btn-primary glyphicon glyphicon-edit disabled"></button>
                                <?php
                                }
                                ?>
                            </td>
...
<script>
    $('.viewModal').on('click', function(e) {
        ...
        $.ajax({
            type: 'ajax',
            method: 'get',
            url: '<?php echo site_url("PurchaseController/View_order");?>',
            data: {
                'desc_id': sale_id
            },
            async: false,
