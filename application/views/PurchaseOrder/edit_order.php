    ...
    <div class="col-lg-12">
        ...
        <div class="col-md-12 ">&nbsp;
            ...
            <div class="col-md-8 col-md-offset-2">&nbsp;
                <form method="post" name="form6" action="<?php echo site_url('PurchaseController/update_order/'.$pur_id) ;?>">
                ...
                if(count($this->session->userdata('purchase_direct')) > 0){
                    ...
                    { 
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo site_url('PurchaseController/unset_prod_edit/'.$key.'/'.$pur_id.'/'.$val[0].'/'.$val[1]) ;?>" class="btn btn-danger glyphicon glyphicon-remove btn-sm"></a></td>
                        </tr>
                        <?php   
                    }
                        ?>
                        ...
                        <tr>
                            <td colspan="3" style="text-align:left;"><b>Receipt No.</b>
                                <input class="form-control" type="text" name="receipt" value="<?php echo $purchase_order_row->receipt?>" placeholder="Please enter receipt number" required >
                            </td>
                            <td colspan="3" style="text-align:left;"><b>Date</b>
                                <input class="form-control" type="text" name="sel_date" value="<?php echo $purchase_order_row->inv_date?>"  placeholder="Please enter date" required >
                            </td>
                            <td colspan="6"><br/>
                                <button class="btn btn-info" name="order">Update Purchase</button>
                            </td>
                        </tr>
                        <?php }?>
                    </table>
                ...
                <form method="post" name="form4">                                 
                    <div class="col-md-12 "> 
                        <div class="col-md-4 col-md-offset-4">
                            ...
                            <a href="<?php echo site_url('PurchaseController/cancel_deal_edit');?>" class="btn btn-default btn-block" >Cancel</a>
                        </div>
                    </div>                  
                </form>
            </div>
