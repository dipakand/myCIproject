...
<div class="row">
    <div class="col-lg-12">
            ...
            <form method="post" name="form2" action="<?php echo site_url('SaleController/product_session');?>">                                 
                <div class="col-md-4 col-md-offset-3 ">
                    <div class="form-group"><b>&nbsp;Search By Product Name: </b>
                        ...
                        <input type="hidden" name="edit_temp" value="<?php echo $sale_row->id;?>" id="">
                    </div>                                                
                </div>                                                                                       
                <div class="col-md-2">
                ...
                <div class="col-sm-12  text-center">  
                    <div class="col-sm-3 ">                                           
                        <div class="form-group"><b>&nbsp;Name </b> 
                            ...
                            <input type="hidden" name="edit_temp_sale" value="<?php echo $sale_row->id;?>" id="">
                        </div>
                    </div>
        ...
        <div class="col-md-12 table-responsive">&nbsp; 
            <form method="post" name="form4" action="<?php echo site_url('SaleController/SaveToSale');?>">
                <?php 
                ...
                <table class="table table-striped text-center ">
                    ...
                    <tr>
                     ...
                     echo $fetch111->name." ".$fetch11->weight;
                        ...
                        <td><input type="number" name="qty_inp[<?php echo $val[0];?>]" id="" class="form-control" min="0" value="<?php echo $val[1]; ?>"></td>
                     ...
                     { ?>
                      ...
                      $igst1 +=$val[7]; ?></td>
                        ...
                        ?>
                        <td><a href="<?php echo site_url('SaleController/unset_product/'.$key.'/'.$sale_row->id);; ?>" class="btn btn-danger btn-sm glyphicon glyphicon-remove"></a></td>
                    </tr>
                    <?php 
                    } 
                    ?>
                ...
                <div class="col-md-12 text-center">
                    <div class="col-md-4 col-md-offset-4">
                        <button type="submit" class="btn btn-warning btn-block">Save To Sale</button>
                    </div>
                </div>
            </form>
        </div> 
        ...
        <div class="col-md-12 text-center">
            <form method="post">
                <div class="col-md-4 col-md-offset-4">
                    <a type="submit" href="<?php echo site_url('SaleController/cancel_edit_temp');?>" class="btn btn-default btn-block">Cancel</a>
                </div>
            </form>
        </div>
    </div>
